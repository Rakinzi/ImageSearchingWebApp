...
def process_image_async(self, image_id: int):
    try:
        ...
        success = image_service.process_single_image(image_id)
        ...
        if success:
            ...
            image = Image.query.get(image_id)
            error_msg = image.processing_error if image else 'Unknown processing error'
